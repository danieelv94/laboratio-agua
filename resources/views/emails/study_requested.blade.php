                    ...
                    <tr>
                        <td style="padding: 40px 30px; background-color: #ffffff;">
                            ...
                            <p style="font-size: 14px; line-height: 22px; color: #475569; margin: 0 0 24px 0;">
                                Su solicitud para el servicio de análisis de agua ha sido registrada de forma exitosa. A continuación, se detallan los datos de seguimiento y pago:
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f8fafc; border-radius: 12px; border: 1px solid #f1f5f9; padding: 20px; margin-bottom: 24px;">
                                <tr>
                                    <td style="padding-bottom: 12px; font-size: 13px; color: #64748b; font-weight: 600; width: 40%;">FOLIO / REFERENCIA:</td>
                                    <td style="padding-bottom: 12px; font-size: 14px; color: #691B31; font-weight: 700;">{{ $studyRequest->referencia_bancaria }}</td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 12px; font-size: 13px; color: #64748b; font-weight: 600;">CANTIDAD DE MUESTRAS:</td>
                                    <td style="padding-bottom: 12px; font-size: 14px; color: #334155; font-weight: 600;">{{ $studyRequest->cantidad_muestras }}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 13px; color: #64748b; font-weight: 600;">IMPORTE A PAGAR:</td>
                                    <td style="font-size: 16px; color: #0d9488; font-weight: 700;">${{ number_format($studyRequest->importe, 2) }} MXN</td>
                                </tr>
                            </table>
                            
                            <p style="font-size: 13px; line-height: 20px; color: #64748b; margin: 0 0 30px 0;">
                                Para continuar con su trámite, es necesario realizar el depósito o transferencia bancaria correspondiente con la referencia indicada y subir su comprobante de pago en su página de seguimiento.
                            </p>
